...
export const firebaseAuthService = {
   ...
   */
  async registerWithEmail(email: string, pass: string, name: string, phone: string, role: 'CITIZEN' | 'VOLUNTEER' | 'SUPERVISOR', ngo_id?: string, ngo_name?: string) {
