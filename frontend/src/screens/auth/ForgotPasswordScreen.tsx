...
export const ForgotPasswordScreen = () => {
  ...
  const handleReset = async () => {
    if (!email.trim()) {
      setStatus({ type: 'error', message: t('auth.emailPlaceholder') });
      return;
    }
        ...
        <View style={styles.form}>
          ...
          {status.type === 'success' && (
            ...
            >
              ...
              <Text style={styles.openEmailText}>{t('auth.openEmailApp')}</Text>
            </TouchableOpacity>
          )}
          ...
          >
            <Text style={styles.roleSelectionText}>{t('auth.backToRoleSelection')}</Text>
          </TouchableOpacity>
        </View>
      </KeyboardAvoidingView>
    </View>
