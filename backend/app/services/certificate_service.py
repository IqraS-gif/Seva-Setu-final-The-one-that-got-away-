...
# Registered Hindi Font Paths
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
PROJECT_ROOT = os.path.dirname(os.path.dirname(BASE_DIR))
ASSETS_DIR = os.path.join(BASE_DIR, "assets")
FONT_REGULAR = os.path.join(ASSETS_DIR, "NotoSansDevanagariRegular.ttf")
FONT_BOLD = os.path.join(ASSETS_DIR, "NotoSansDevanagariBold.ttf")
# Frontend logo path
...
try:
    ...
    if os.path.exists(FONT_REGULAR):
        ...
        print(f"[Cert Service] Hindi font files NOT FOUND at {FONT_REGULAR}. Falling back to Helvetica.")
